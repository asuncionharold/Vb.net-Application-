Public Class Shapes
    ...
    Private Sub Shapes_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Timer1.Start()
        display = True
        ...
        '>>>>>>>>>>> Declaration
        Pic1Vb.Image = Image.FromFile("C:\Users\Harold\Documents\Visual Studio 2010\Projects\Software Engineering\Software Engineering\Shapes\rectangle.png")
        Pic1Vb.SizeMode = PictureBoxSizeMode.StretchImage
        Answer1 = False
        Pic2Vb.Image = Image.FromFile("C:\Users\Harold\Documents\Visual Studio 2010\Projects\Software Engineering\Software Engineering\Shapes\rectangle.png")
        Pic2Vb.SizeMode = PictureBoxSizeMode.StretchImage
        Answer2 = False
        Pic3Vb.Image = Image.FromFile("C:\Users\Harold\Documents\Visual Studio 2010\Projects\Software Engineering\Software Engineering\Shapes\triangle.png")
    ...
    Private Sub Pic1Vb_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Pic1Vb.Click
        ...
        ElseIf Answer1 = True And ctr = 1 Then
            ...
            My.Computer.Audio.Play(My.Resources.musicAbc, AudioPlayMode.BackgroundLoop)
            Pic1Vb.Image = Image.FromFile("C:\Users\Harold\Documents\Visual Studio 2010\Projects\Software Engineering\Software Engineering\Shapes\triangle.png")
            Pic1Vb.SizeMode = PictureBoxSizeMode.StretchImage
            Answer1 = False
            Pic2Vb.Image = Image.FromFile("C:\Users\Harold\Documents\Visual Studio 2010\Projects\Software Engineering\Software Engineering\Shapes\heart.png")
            Pic2Vb.SizeMode = PictureBoxSizeMode.StretchImage
            Answer2 = True
            Pic3Vb.Image = Image.FromFile("C:\Users\Harold\Documents\Visual Studio 2010\Projects\Software Engineering\Software Engineering\Shapes\triangle.png")
            Pic3Vb.SizeMode = PictureBoxSizeMode.StretchImage
    ...
    Private Sub Pic3Vb_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Pic3Vb.Click
        If Answer3 = True And ctr = 0 Then
            My.Computer.Audio.Play(My.Resources.star, AudioPlayMode.WaitToComplete)
            My.Computer.Audio.Play(My.Resources.musicAbc, AudioPlayMode.BackgroundLoop)
            Pic1Vb.Image = Image.FromFile("C:\Users\Harold\Documents\Visual Studio 2010\Projects\Software Engineering\Software Engineering\Shapes\rectangle.png")
            Pic1Vb.SizeMode = PictureBoxSizeMode.StretchImage
            ...
            Pic2Vb.SizeMode = PictureBoxSizeMode.StretchImage
            Answer2 = False
            Pic3Vb.Image = Image.FromFile("C:\Users\Harold\Documents\Visual Studio 2010\Projects\Software Engineering\Software Engineering\Shapes\heart.png")
            Pic3Vb.SizeMode = PictureBoxSizeMode.StretchImage
            Answer3 = False
            ctr = ctr + 1 '2
